var arrLang = {
    ...
    'TC': {
      ...
      'feature_2': '詳盡統計數據',
      'feature_2_p': '遊戲大堂清晰展示百家樂本靴及過往100局「庄」、「閒」、「和」及「對子」勝出比例，各檯趨勢一目了然。的的的的的玩家如遇上心水局數，更可用「快速投注」功能在大堂直接下注。 ',
      'feature_3': '平台及自設好路提示',
    ...
    'SC': {
      ...
      'feature_2': '详细统计数据',
      'feature_2_p': '游戏大堂清晰地展示百家乐本靴及过往100局「庄」、「闲」、「和」及「对子」胜出比率，各游戏台趋势一目了然。玩家如遇上合意的局数，更可用「快速投注」功能在大堂直接下注。',
      'feature_3': '平台及自设好路提示',
