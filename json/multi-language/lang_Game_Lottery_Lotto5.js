var arrLang = {
    ...
    'TC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '時時彩是紅透全國彩票遊戲。遊戲不僅富有趣味性，投注方式也是五花八門，高賠率。玩家只需要押中開獎彩球號碼排列組合，豐厚獎金隨即奉上。',
      'feature_1.1': '投注選項',
      'feature_1.2': '豐富多變',
      'feature_1_p': '「時時彩」備有多種投注組合，且每款組合派彩回報也各有不同，賠率千變萬化，玩家隨時搏取更豐厚獎金。',
      'feature_2.1': '自定籌碼金額',
      'feature_2.2': '',
      'feature_2_p': '除了預設籌碼外，玩家可跳轉至「娛樂」模式，設定不同籌碼金額，贏取豐盛獎金。',
      'feature_3.1': '數據 掌握',
      'feature_3.2': '遊戲走勢',
    ...
    'SC': {
      ...
      //
      'Lottery':'彩票',
      'gameDetail_p1': '时时彩是红透全国彩票游戏。游戏不仅富有趣味性，投注方式也是五花八门，高赔率。玩家只需要押中开奖彩球号码排列组合，丰厚奖金随即奉上。',
      'feature_1.1': '投注选项',
      'feature_1.2': '丰富多变',
      'feature_1_p': '「时时彩」备有多种投注组合，且每款组合派彩回报也各有不同，赔率千变万化，玩家随时搏取更丰厚奖金。',
      'feature_2.1': '自定筹码金额',
      'feature_2.2': '',
      'feature_2_p': '除了预设筹码外，玩家可跳转至「娱乐」模式，设定不同筹码金额，赢取丰盛奖金。',
      'feature_3.1': '数据 掌握',
      'feature_3.2': '遊戲走勢',
